...
public class Thaumcraft {
    ...
    // Create a Deferred Register to hold CreativeModeTabs which will all be registered under the "thaumcraft" namespace
    ...
    // Creates a new food item with the id "thaumcraft:example_id", nutrition 1 and saturation 2
    public static final DeferredItem<Item> EXAMPLE_ITEM = ITEMS.registerSimpleItem("example_item", new Item.Properties().food(new FoodProperties.Builder()
            .alwaysEdible().nutrition(1).saturationModifier(2f).build()));

    // Creates a creative tab with the id "thaumcraft:example_tab" for the example item, that is placed after the combat tab
