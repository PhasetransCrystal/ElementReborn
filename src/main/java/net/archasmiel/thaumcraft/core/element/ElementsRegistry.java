...
public class ElementsRegistry {
    ...
    @Nullable public static MagicElement getElement(ResourceLocation resourceLocation) {
        return REGISTRY_ELEMENTS.get(resourceLocation);
    }

    @Nullable public static MagicElement getElement(String resourceLocation) {
        return REGISTRY_ELEMENTS.get(ResourceLocation.parse(resourceLocation));
    }

    @Nullable public static MagicElement getElementByName(String name) {
